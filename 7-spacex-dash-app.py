...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                #dcc.RangeSlider(id='payload-slider',...)
                                 dcc.RangeSlider(id='payload-slider',
                                                ...
                                                marks={0: '0 kg', 2500: '2500', 5000: '5000',
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        success_counts['class'] = success_counts['class'].map({1: 'Success', 0: 'Failed'})
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_site_df,
                         ...
                         y='class',
                         color='Booster Version Category',
                         title=f'Correlation Between Payload and Launch Success for site {entered_site}')
        return fig
